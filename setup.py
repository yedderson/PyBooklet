...
setup(
    ...
    description="Generates booklets out from pdf files",
    long_description= "a GUI utility to convert a regular pdf book into 2 pages-per-sheet / double sided booklet ready for printing",
    platforms='any',
    license='BSD',
